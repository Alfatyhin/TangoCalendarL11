...
@section('content')
    ...
    <strong>Terms &amp; Conditions</strong> <p>
        ...
        The Tango Calendar app stores and processes personal data that
        you have provided to us, to provide [my/our]
        ...
        that the Tango Calendar app won’t work properly or at all.
    </p> <div><p>
        ...
        currently available on Android и iOS – the requirements for the
        system(and for any additional systems we
        decide to extend the availability of the app to) may change,
        and you’ll need to download the updates if you want to keep
        using the app. [Developer/Company name] does not promise that it
        will always update the app so that it is relevant to you
        and/or works with the Android и iOS version that you have
